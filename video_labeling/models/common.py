...
from .utils import (LOGGER, check_suffix, check_version, xywh2xyxy)
# from utils.general import (LOGGER, check_suffix, check_version, xywh2xyxy)
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, data=None):
        ...
        if pt:  # PyTorch
            ...
            self.model = model.half()  # explicitly assign for to(), cpu(), cuda(), half()
            # self.model.model_ = [self.model.model[i] for i in range(11)] + [self.model.model[-2], self.model.model[-1]]
