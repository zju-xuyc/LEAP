...
# ReID weight 
_C.MODEL.EMB_WEIGHT = "XXX"
# If Yolo Using DNN
_C.MODEL.YOLO_DNN = False
# Dataset Rooting
_C.MODEL_YOLO_CLASSSET = "XXX"
...
_C.OUTPUT.VISUAL_DETECT = "XXX"
# Output detection embedding result
_C.OUTPUT.EMBED_DETECT = "XXX"
# Output detection ground truth embedding
_C.OUTPUT.GT_EMBED_DETECT = "XXX"
# Output gt detection visual result
_C.OUTPUT.GT_DETECT = "XXX"
