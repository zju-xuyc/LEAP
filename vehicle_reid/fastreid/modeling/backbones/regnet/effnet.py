...
from vehicle_reid.fastreid.modeling.backbones.build import BACKBONE_REGISTRY
from vehicle_reid.fastreid.utils import comm
from vehicle_reid.fastreid.utils.checkpoint import get_missing_parameters_message, get_unexpected_parameters_message
