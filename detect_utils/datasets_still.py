...
from detect_utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from detect_utils.torch_utils import torch_distributed_zero_first
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def cache_images(self, path=Path('./labels.cache'), prefix=''):
        ...
        x = {}  # dict
        nm, nf, ne, nc = 0, 0, 0, 0  # number missing, found, empty, duplicate
        pbar = tqdm(self.img_files, desc='Scanning images',
        ...
        for i, im_file in enumerate(pbar):
            try:
                ...
                raise
                print(
                    f'{prefix}WARNING: Ignoring corrupted image {im_file}: {e}')
        ...
        if nf == 0:
            print(f'{prefix}WARNING: No images found in {path}. See {help_url}')
