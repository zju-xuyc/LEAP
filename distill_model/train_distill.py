...
def train(hyp, opt, device, tb_writer=None):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, (imgs, targets, _, _) in pbar:
            ...
            ni = i + nb * epoch
            # targets img_id class x_m y_m w h
...
if __name__ == '__main__':
    ...
    parser.add_argument('--distill-ratio', type=float,
                        default=0.25, help='distill loss ratio in total loss')
    ...
    parser.add_argument('--full-output-loss',
                        action='store_false', help='use full output to compute distill loss')
    parser.add_argument('--cfg', type=str,
                        default='models/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='data/veh_large.yaml', help='data.yaml path')
    parser.add_argument(
